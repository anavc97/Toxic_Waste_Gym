...
if [ "$HOSTNAME" = "artemis" ] || [ "$HOSTNAME" = "poseidon" ] ; then
  ...
  python "$script_path"/run_train_toxic_multi_model.py --logs-dir /mnt/scratch-artemis/miguelfaria/logs/toxic_waste --models-dir /mnt/data-artemis/miguelfaria/toxic_waste/models --data-dir /mnt/data-artemis/miguelfaria/toxic_waste/data --buffer-method uniform --initial-temp 1.0 --train-only-green --iterations 6000 --eps-type linear --eps-decay 0.5 --buffer-size 5000 --batch-size 32 --game-levels cramped_room --curriculum-learning --curriculum-model-path /mnt/data-artemis/miguelfaria/toxic_waste/models/best/only_movement --pick-all # --restart --checkpoint-file "$chkpt_dir"/v2_train_checkpoint_data.json
else
